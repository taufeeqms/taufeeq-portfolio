...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Taufeeq M S — AI/ML Student & Python Developer" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Taufeeq M S" },
      { property: "og:title", content: "Taufeeq M S — AI/ML Student & Python Developer" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@500;600;700&family=Poppins:wght@500;600;700;800&family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap",
      },
    ],
  }),
